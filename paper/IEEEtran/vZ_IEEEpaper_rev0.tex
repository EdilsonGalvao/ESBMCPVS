...
\color{red} IMPORTANTE! aqui vale o mesmo comentário da revisão anterior. Atente que o HOMER Pro faz otimização e entrega uma solução com equipamentos comerciais (mas apenas para baterias e painéis solares). Portanto precisamos nos posicionar aqui do diferencial da nossa técnica, que tem a ver com a cobertura do design-space
\color{black}
