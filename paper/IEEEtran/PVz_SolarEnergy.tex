...
\begin{abstract}
Energy consumption forecasting growth for the world is $1.3$\% until $2040$, and solar photovoltaic systems had the highest adoption as an alternative for fossil fuels. We develop an automated formal synthesis technique for stand-alone systems, named PVz, is based on the counterexample-guided inductive synthesis with the purpose to improve the optimal sizing of stand-alone systems.Starting with the electrical demands of a house, PVz seeks the best possible combination of electrical devices in termos of  electrical compatibility, global lowest price, 20-years horizon of operation and maintenance. We present our results based on seven case studies, Targeting to validate and compare our results, we obtained the optimal sizing from a commercial optimization tool. We conclude that our approach provides more accurate results than existing literature approaches and with impressive time to respond compared with the previous automatic synthesis techniques.
