...
\begin{flushleft}
	Ranga Pitchumani \\
	Editor-in-Chief \\
	Virginia Tech Research Center Department of Mechanical Engineering \\
  EUA \\
	Solar Energy journal
    \end{flushleft}
 
\indent Dear Professor Pitchumani,
\vi

Please find enclosed our manuscript entitled ``Multi-core synthesis and maximum satisfiability for optimal sizing of solar photovoltaic systems'' by Edilson Galvao, Alessandro Trindade, and Lucas Cordeiro, which we would like to submit for publication in the journal of Solar Energy.
